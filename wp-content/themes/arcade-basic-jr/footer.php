		...
		<div id="footer-content" class="container">
			<div class="row">
				<div class="copyright col-lg-12">
					...
					<span class="credit-link pull-right"><i class="fa fa-leaf"></i><?php printf( __( 'Designed by %s.', 'arcade' ), '<a href="https://themes.bavotasan.com/">bavotasan.com</a> and <a href="http://www.lucaslima.blog.br/">Lucas Lima</a>' ); ?></span>
				</div><!-- .col-lg-12 -->
			</div><!-- .row -->
