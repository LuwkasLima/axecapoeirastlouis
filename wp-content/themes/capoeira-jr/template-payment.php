 ...
 *
 * Description: A full width page template that will display a widget area for payment options
 *
 * @since 1.0.3
 */
get_header();

	// Display payment widgetized area
	if ( is_active_sidebar( 'payment-page-area' ) ) {
		?>
		<div id="payment-page-area">
			<div class="container">
				<div class="row">
					<?php dynamic_sidebar( 'payment-page-area' ); ?>
				</div>
			</div>
		</div>
		<?php
